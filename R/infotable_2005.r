...
#'
#' @export
infotable_2005<- function(variable, print=F) {
  ...
  na_pattern <- "^NA|NAP|other countries|no income|Refuse|Refused|Don't know|uncertain|no answer|can't choose|Can't say|Country specific variable not applicable for this country|Not in paid work|No own income, not in paid work"
